#Creation of database using sqlite3
import sqlite3

#creating connection between database and program
conn = sqlite3.connect('db.db')
c = conn.cursor()

#create mnt and mdt if not created
...
#sp is stack pointer points the current value of stack
global sp
